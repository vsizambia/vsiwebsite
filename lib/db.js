...
export async function ensureVolunteerTable() {
  await pool.query(`
    CREATE TABLE IF NOT EXISTS volunteer_applications (
      id BIGSERIAL PRIMARY KEY, full_name TEXT NOT NULL, age INTEGER, nationality TEXT, email TEXT NOT NULL, phone TEXT NOT NULL,
      province TEXT, district TEXT, constituency TEXT, ward TEXT, location TEXT, current_occupation TEXT, education TEXT,
      category TEXT NOT NULL, skills TEXT NOT NULL, availability TEXT NOT NULL, motivation TEXT NOT NULL,
      volunteering_elsewhere BOOLEAN NOT NULL DEFAULT FALSE, other_volunteering_details TEXT, past_volunteer_positions TEXT,
      reference_name TEXT, reference_organization TEXT, reference_phone TEXT, reference_email TEXT,
      criminal_conviction BOOLEAN NOT NULL DEFAULT FALSE, criminal_offence_details TEXT, profile_picture TEXT,
