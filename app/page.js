    ...
    <main>
      ...
      <section className="work section-shell" id="work">
        <div className="section-heading-row work-heading-row">
          <div className="work-heading-copy"><h2>Work that helps young people lead, serve and shape change.</h2></div>
          <div className="work-heading-image"><Image src="/images/vsi what we stand on 1.jpg" alt="VSI community and youth action" fill sizes="(max-width: 900px) 100vw, 42vw" /></div>
        </div>
