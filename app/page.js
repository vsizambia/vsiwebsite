  ...
  return (
    <main>
      ...
      <section className="hero"><div className="hero-image"><Image src="/images/vsi-parliament.jpg" alt="Students participating in a civic engagement activity" fill priority sizes="100vw" /></div><div className="hero-overlay" />
        <div className="section-shell hero-content"><p className="kicker light">VISIONARY STUDENTS INITIATIVE</p><h1>Students at the centre of <em>national development.</em></h1><p>We promote policies and initiatives that give young people the knowledge, voice, skills and opportunities to participate meaningfully in Zambia's future.</p><div className="hero-actions"><a className="button button-yellow" href="#about">Discover VSI <span>↓</span></a><a className="text-link light-link" href="/story">Our story <span>↗</span></a></div></div>
      </section>
      ...
      <section className="photo-grid section-shell"><div className="photo-large"><Image src="/images/vsi-conference.jpg" alt="VSI conference and public dialogue" fill sizes="(max-width: 900px) 100vw, 50vw" /></div><div className="photo-stack"><div><Image src="/images/vsi-school-programme.jpg" alt="VSI school engagement programme" fill sizes="(max-width: 900px) 100vw, 50vw" /></div><div><Image src="/images/vsi-community-dialogue.jpg" alt="VSI community dialogue" fill sizes="(max-width: 900px) 100vw, 50vw" /></div></div></section>
