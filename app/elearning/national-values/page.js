...
export const metadata = {
  ...
  description: "Teaching notes on Zambia's national values and principles for secondary school students.",
  alternates: { canonical: "/elearning/national-values" },
};

const values = [
  { title: "Morality and ethics", text: "Doing what is right, honest and responsible, even when nobody is watching." },
  { title: "Patriotism and national unity", text: "Loving Zambia, protecting its interests and promoting peace and unity." },
  { title: "Democracy and constitutionalism", text: "Respecting democratic participation, the Constitution and the rule of law." },
  { title: "Human dignity, equity, social justice, equality and non-discrimination", text: "Respecting every person and treating people fairly, without unfair discrimination." },
  { title: "Good governance and integrity", text: "Using leadership and public responsibility honestly, fairly and accountably." },
  { title: "Sustainable development", text: "Meeting today's needs while protecting resources and opportunities for future generations." },
];
...
const everydayValues = [
  ...
  ["Sustainable Development", "Making choices that use resources wisely and consider the needs of future generations."],
];
...
const practiceTable = [
  ...
  ["A group is deciding how to use limited shared resources.", "Sustainable development", "Consider present needs while avoiding waste and protecting future needs."],
];
...
const review = [
  ...
  ["Sustainable development", "Use resources responsibly and think about future generations."],
];
    ...
    <main>
      ...
      <section className="lesson-hero">
        <div className="section-shell">
          ...
          <p className="lesson-subtitle">Teaching Notes for Secondary School Students</p>
      ...
      <article className="lesson-content section-shell">
        ...
        <section className="lesson-section">
          ...
          <p>National values are not only ideas written in the Constitution. They should be visible in our daily choices.</p>
        ...
        <section className="lesson-section">
          ...
          <div className="case-grid">
            ...
            <div><span>04</span><h3>Shared Resources</h3><p>Your group has limited materials for a project. How can you make fair choices and avoid unnecessary waste?</p></div>
        ...
        <section className="lesson-closing">
          ...
          <p>Ask learners to choose one national value and describe one action they can take at school, at home or in their community. Discuss how the value should guide the decision they make.</p>
          ...
          <div className="lesson-note emphasis"><strong>Next: From values to action</strong><p>In Module 02, we move from knowing what is right to using those values in practical community service.</p></div>
        </section>
      </article>
