...
export default function StoryPage() {
  return (
    <main>
      ...
      <section className="story-page-hero"><div className="section-shell story-page-hero-grid story-image-left"><div className="story-page-image"><Image src="/images/vsi-parliament.jpg" alt="VSI civic engagement at Parliament" fill priority sizes="(max-width: 900px) 100vw, 50vw" /></div><div><p className="kicker">THE #VSI STORY</p><h1>From a student idea to a growing movement for <em>national development.</em></h1><p>It started with a bold belief: students should not simply prepare for the future — they should have a meaningful role in shaping it.</p></div></div></section>

      <section className="story-timeline section-shell">
        <div className="story-year">
          <div className="story-year-image"><Image src="/images/vsi story 1.jpg" alt="VSI story — the beginning" fill sizes="(max-width: 900px) 100vw, 50vw" /></div>
          <div className="story-year-copy"><span className="story-date">16 AUGUST 2018</span><p className="kicker">THE BEGINNING</p><h2>It all started at Cavendish University Zambia.</h2><p>It all started on August 16th, 2018, at Cavendish University Zambia. That's when #VSI was born, with a bold mission to redefine student participation in national development through community service.</p></div>
        </div>

        <div className="story-year">
          <div className="story-year-image"><Image src="/images/vsi story Room full of ideas.jpg" alt="VSI story — a room full of ideas" fill sizes="(max-width: 900px) 100vw, 50vw" /></div>
          <div className="story-year-copy"><span className="story-date">THE LAUNCH</span><p className="kicker">A ROOM FULL OF IDEAS</p><h2>A launch shaped by people who believed in possibility.</h2><p>Our launch event brought together inspiring voices. Br. Erasto Chanda from CUZ management emphasised academic excellence and market-relevant courses. Mrs. Tiwonge Zyambo of Velcro HR Consultancy and Madam Lusungu Ndlovu shared insights on human resources and the need for students to develop innovative skills. Public policy specialist Mr. Stephen Nyoni, poet George Samuel Phiri, and Beatrice Phiri — who spoke passionately about climate change and environmental protection — also contributed to the conversation.</p></div>
        </div>

        <div className="story-year">
          <div className="story-year-image"><Image src="/images/From Club to NGO.jpg" alt="VSI story — from club to NGO" fill sizes="(max-width: 900px) 100vw, 50vw" /></div>
          <div className="story-year-copy"><span className="story-date">THE JOURNEY</span><p className="kicker">FROM CLUB TO NGO</p><h2>What began as a small club has grown into a thriving NGO.</h2><p>Fast forward to today, what began as a small club at CUZ has grown into a thriving NGO. We've made significant contribution to national development through public policy advocacy and service provision, partnering with government ministries, departments, and agencies.</p><p>Our community work has also advanced the United Nations' Sustainable Development Goals (SDGs) 1, 2, 3, 4, 6, 11, 13, and 17.</p></div>
        </div>
